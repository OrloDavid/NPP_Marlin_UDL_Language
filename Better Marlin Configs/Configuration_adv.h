...
// If the Nozzle or Bed falls when the Z stepper is disabled, set its resting position here. !!! Useful for version 1 of the Xsymmetry Mod
 ...
 */
//#define XY_FREQUENCY_LIMIT      40  // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
...
#define MINIMUM_PLANNER_SPEED 0.05 // (mm/s)  :Def 0.05 

//#define Z_LATE_ENABLE // Enable Z the last moment. Needed if your Z driver overheats.
// Might be useful for Underslung XSymmetry Mod if having Stepper heat Issues
...
#define HOMING_BUMP_DIVISOR { 7, 7, 12 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate) 
...
//
  ...
  //#define TEMP_CHAMBER_HYSTERESIS     1   // Temperature proximity considered "close enough" to the target
...
//#define EXTRUDER_RUNOUT_PREVENT 
  ...
  #define EXTRUDER_RUNOUT_SPEED 300  // (mm/min)
...
//#define HOTEND_IDLE_TIMEOUT
  ...
  //#define HOTEND_IDLE_MIN_TRIGGER   180     // Minimum temperature to enable hotend protection
  //#define HOTEND_IDLE_NOZZLE_TARGET   0     // Safe temperature for the nozzle after timeout
  //#define HOTEND_IDLE_BED_TARGET      0     // Safe temperature for the bed after timeout
#endif
...
#define MICROSTEP_MODES { 16, 16, 16, 16, 16, 16 } // [1,2,4,8,16,32]
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {  80*60, 80*60, 30*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
